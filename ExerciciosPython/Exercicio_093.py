...
programa vai ler o nome do jogador e quantas partidas ele jogou. Depois vai ler a quantidade de gols
...
for key, valor in enumerate(jogador['gols']):
    print(f'   => Na partida {key}, fez {valor} gols ')
